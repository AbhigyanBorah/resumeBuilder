...
const Resume = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    setColumns([
      ...
      [sections.workExp, sections.skills, sections.other],
    ]);
  }, []);
    ...
    <div ref={ref}>
      <div ref={containerRef} className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.image}>{info.profile?.detail?.image}</div>
          ...
          <div className={styles.links}>
            ...
            {info.profile?.detail?.address ? (
              <a className={styles.link}>
                <LocationOnIcon /> {info.profile?.detail?.address}
              </a>
            ) : (
              <span />
            )}
