    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        ...
        <InputControl
          ...
          placeholder="Enter the Tech-stack used in your project"
          onChange={(event) =>
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          ...
          value={values.title}
          placeholder="Enter name eg. B-tech"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
        <InputControl
          ...
          placeholder="Enter the year of course completion"
          onChange={(event) =>
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <input
          ...
          id="select-image"
          style={{ display: 'none' }}
          onChange={(e) => { imgOnChange2(e); setValues((prev) => ({ ...prev, college: e.target.value })) }}
        />
        {imageUrl && profileImage && (
          <Box mt={1} mb={2}>
            <img src={imageUrl} alt={profileImage.name} height="150px" width="150px" />
          </Box>
        )}
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.body}>
        ...
        {generateBody()}
        <Button color='primary' size='large' variant='contained' onClick={handleSubmission} sx={{
